        ...
        <div class="card-body">
            ...
            <div class="mb-4">
                ...
                <div class="form-check">
                    ...
                    <input class="form-check-input" type="checkbox" @if ($user->email_verified_at) checked @endif
                        disabled>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        @foreach ($logs as $log)
                            <tr>
                                ...
                                <td>{{ $log->created_at->format('M d, Y H:i') }} <span
                                        class="badge bg-primary">{{ $log->created_at->diffForHumans() }}</span></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
